...
write.csv(tT, file="DEG.csv", row.names=F)
...
par(mar=c(7,4,2,1))
title <- paste ("GSE141801", "/", annotation(gset), sep ="")
...
par(mar=c(4,4,2,1))
title <- paste ("GSE141801", "/", annotation(gset), " value distribution", sep ="")
...
plotSA(fit2, main="Mean variance trend, GSE141801")

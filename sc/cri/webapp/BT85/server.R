...
shinyServer(function(input, output, session) { 
 ...
 optCrt="{ option_create: function(data,escape) {return('<div class=\"create\"><strong>' + '</strong></div>');} }" 
  ...
  output$sc1a1oup1.ui <- renderUI({ 
    plotOutput("sc1a1oup1", height = pList[input$sc1a1psz],width = "90%") 
  }) 
  ...
  output$sc1a1oup2.ui <- renderUI({ 
    plotOutput("sc1a1oup2", height = pList[input$sc1a1psz],width = "90%") 
  }) 
  ...
  output$sc1a2oup1.ui <- renderUI({ 
    plotOutput("sc1a2oup1", height = pList[input$sc1a2psz],width = "90%") 
  }) 
  ...
  output$sc1a2oup2.ui <- renderUI({ 
    plotOutput("sc1a2oup2", height = pList[input$sc1a2psz],width = "90%") 
  }) 
  ...
  output$sc1a3oup1.ui <- renderUI({ 
    plotOutput("sc1a3oup1", height = pList[input$sc1a3psz],width = "90%") 
  }) 
  ...
  output$sc1a3oup2.ui <- renderUI({ 
    plotOutput("sc1a3oup2", height = pList[input$sc1a3psz],width = "90%") 
  }) 
  ...
  output$sc1b2oup1.ui <- renderUI({ 
    plotOutput("sc1b2oup1", height = pList2[input$sc1b2psz],width = "90%") 
  }) 
  ...
  output$sc1c1oup.ui <- renderUI({ 
    plotOutput("sc1c1oup", height = pList2[input$sc1c1psz],width = "90%") 
  }) 
...
output$sc1c2oup.ui <- renderUI({ 
  plotOutput("sc1c2oup", height = pList2[input$sc1c2psz],width = "90%") 
}) 
...
output$sc1c2oup.png <- downloadHandler( 
  ...
  output$sc1d1oup.ui <- renderUI({ 
    plotOutput("sc1d1oup", height = pList3[input$sc1d1psz],width = "90%") 
  }) 

...
os.chdir('/home/hzg/rna/sc/cri/velocity')
#############################################
adata1 = anndata.read_loom('21047FL-120-01-01-01-CzL.loom')
adata2 = anndata.read_loom('21047FL-120-02-01-01-CzS.loom')
adata3 = anndata.read_loom('21047FL-120-03-01-01-DMSO.loom')
...
ident_colours = ["#544799","#CF5A79","#D2C564","#5DA373"]
scv.pp.filter_and_normalize(adata)
scv.pp.moments(adata)
#scv.tl.recover_dynamics(adata,n_jobs=10)
scv.tl.velocity(adata, mode = "stochastic")
scv.tl.velocity_graph(adata,n_jobs=10)
scv.pl.velocity_embedding_stream(adata, basis = 'umap',color="clusters",palette=ident_colours,density=3,dpi=200,size=60,alpha=0.8,save="UMAP_velo.pdf")

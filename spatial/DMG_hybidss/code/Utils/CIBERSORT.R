...
#main function
CIBERSORT <- function(fout,sig_matrix, mixture_file, perm=0, QN=TRUE, absolute=FALSE, abs_method='sig.score'){
    ...
    #save results
    write.table(rbind(header,output), file=fout, sep="\t", row.names=F, col.names=F, quote=F)

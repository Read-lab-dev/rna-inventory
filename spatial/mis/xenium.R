...
#              alpha = 0.7, split.by="first_type")
ImageDimPlot(xenium.obj, fov = "zoom", axes = TRUE, border.color = "white", border.size = 0.05, 
             cols = "alphabet",coord.fixed = FALSE,alpha = 0.7,
             molecules = "CD86",mols.cols = "yellow",group.by = "predicted.celltype")

...
out1 <- Read10X("/home/hzg/rna/seq/21047FL-89/21047FL-89-01-01/outs/filtered_feature_bc_matrix/")
out2 <- Read10X("/home/hzg/rna/seq/21047FL-89/21047FL-89-01-02/outs/filtered_feature_bc_matrix/")
out3 <- Read10X("/home/hzg/rna/seq/21047FL-89/21047FL-89-01-03/outs/filtered_feature_bc_matrix/")
out4 <- Read10X("/home/hzg/rna/seq/21047FL-89/21047FL-89-01-04/outs/filtered_feature_bc_matrix/")
...
int.seu <- RunHarmony(int.seu, group.by.vars = "group", reduction = "pca", assay.use = "pca", reduction.save = "harmony")
...
int.seu <- FindClusters(int.seu,resolution = 0.5,algorithm = 4,method = "igraph")

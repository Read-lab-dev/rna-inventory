...
ui <- tagList(
  fluidPage(
    ...
    titlePanel(
      windowTitle = "BT109 Engrafted Tumor Cells",
      title = tags$a(
        href = "https://www.reneereadlab.org/",  # URL to link to
        target = "_blank",  # Opens the link in a new tab
        div(
          img(src = "./mylogo.png", height = 40),  # Image source and size
          span("Read Lab", style = "font-size: inherit; font-weight: normal; color: #012169")  # Text next to the image
        )
      )
    ),
    ##Start NavbarPage
    navbarPage( 
      NULL, 
      title=div("BT109 Engrafted Tumor cells (DMG)"),
        ...
        sidebarLayout(position="left",
                      sidebarPanel(
                        ...
                        column(
                          ...
                          column(12, p(), style = "background-color: transparent;"),
                          fluidRow(column(
                            12,
                            selectInput(
                              "sc1a1inp1",
                        ...
                        # End of column1 (6 space)
                        column(
                          12,
                          h4("Gene Expression"),
                          selectInput("sc1a1inp2", "Gene name:", choices =
                                        NULL) %>%
                            helper(
                              type = "inline",
                              size = "m",
                        ...
                        actionButton("sc1a1togL", "Subset cells"),
                        conditionalPanel(
                        ...
                        column(12, p(), style = "background-color: transparent;"),
                        actionButton("sc1a1tog0", "Graphics controls"),
                        conditionalPanel(condition = "input.sc1a1tog0 % 2 == 1",
                                         fluidRow(
                                           column(
                                             12,
                                             sliderInput(
                        ...
                        column(12, p(), style = "background-color: transparent;"),
                        actionButton("sc1a1tog9", "Cell numbers & statistics")
                      ),   # End of sidebar Panel (4 space) 
                      mainPanel(width=10,
                                fluidRow(
                                  column( 
                                    5, h4("Cell information"), 
                                    fluidRow(column(12, uiOutput("sc1a1oup1.ui"))), 
                                    actionButton("sc1a1tog1", "Customize Fig"), 
                                  ...
                                  column( 
                                    5, h4("Gene expression"), 
                                    fluidRow(column(12, uiOutput("sc1a1oup2.ui"))), 
                                    actionButton("sc1a1tog2", "Customize Fig"), 
      ...
      tabPanel( 
        ...
        sidebarLayout(
          sidebarPanel(width = 2,
                       ...
                       column(12, p(), style = "background-color: transparent;"),
                       column(12, h4("Gene Information"),
                              selectInput("sc1a2inp1", "Cell information 1:", 
                                          choices = sc1conf$UI, 
                                          selected = sc1def$meta1) %>%  
                       ...
                       column( 
                         12, selectInput("sc1a2inp2", "Cell information2:", 
                                         choices = sc1conf$UI, 
                       ...
                       actionButton("sc1a2togL", "Subset cells"), 
                       conditionalPanel( 
                       ...
                       column(12, p(), style = "background-color: transparent;"),
                       actionButton("sc1a2tog0", "Graphics controls"), 
                       conditionalPanel( 
                         condition = "input.sc1a2tog0 % 2 == 1", 
                         fluidRow( 
                           column( 
                             12, sliderInput("sc1a2siz", "Point size:", 
                           ...
                           column( 
                             12, radioButtons("sc1a2asp", "Aspect ratio:", 
                                              choices = c("Square", "Fixed", "Free"), 
          ...
          mainPanel(width=10,
                    fluidRow( 
                      column( 
                        5,h4("Cell information 1"), 
                        fluidRow(column(12, uiOutput("sc1a2oup1.ui"))), 
                        actionButton("sc1a2tog1", "Customize Fig"), 
                        conditionalPanel( 
                      ...
                      column( 
                        5, h4("Cell information 2"), 
                        fluidRow(column(12, uiOutput("sc1a2oup2.ui"))),
                        actionButton("sc1a2tog2", "Customize Fig"), 
                        conditionalPanel( 
      ...
      tabPanel( 
        ...
        sidebarLayout(
          sidebarPanel(width = 2,
                       ...
                       column(12, p(), style = "background-color: transparent;"),
                       column(12, h4("Gene Expression"),
                              selectInput("sc1a3inp1", "Cell information 1:", 
                                          choices = sc1conf$UI, 
                                          selected = sc1def$meta1) %>%  
                                helper(type = "inline", size = "m", fade = TRUE, 
                                       title = "Cell information to colour cells by", 
                       ...
                       column( 
                         12, selectInput("sc1a3inp2", "Cell information2:", 
                                         choices = sc1conf$UI, 
                                         selected = sc1def$meta2) %>%  
                           helper(type = "inline", size = "m", fade = TRUE, 
                                  title = "Cell information to colour cells by", 
                       ...
                       actionButton("sc1a3togL", "Subset cells"), 
                       conditionalPanel( 
                       ...
                       column(12, p(), style = "background-color: transparent;"),
                       actionButton("sc1a3tog0", "Graphics controls"), 
                       conditionalPanel( 
                         condition = "input.sc1a3tog0 % 2 == 1", 
                         fluidRow( 
                           column( 
                             12, sliderInput("sc1a3siz", "Point size:", 
                                             min = 0, max = 4, value = 1.25, step = 0.25), 
                           ...
                           column( 
                             12, radioButtons("sc1a3asp", "Aspect ratio:", 
                                              choices = c("Square", "Fixed", "Free"), 
                                              selected = "Square", inline = TRUE), 
          ...
          mainPanel(width=10,
                    fluidRow( 
                      column( 
                        ...
                        actionButton("sc1a3tog1", "Customize Fig"), 
                        conditionalPanel( 
                          condition = "input.sc1a3tog1 % 2 == 1", 
                          radioButtons("sc1a3col1", "Colour (Continuous data):", 
                                       choices = c("White-Red", "Blue-Yellow-Red", 
                                                   "Yellow-Green-Purple"), 
                                       selected = "Blue-Yellow-Red"), 
                          radioButtons("sc1a3ord1", "Plot order:", 
                                       choices = c("Max-1st", "Min-1st", "Original", "Random"), 
                                       selected = "Original", inline = TRUE), 
                          checkboxInput("sc1a3lab1", "Show cell info labels", value = TRUE) 
                        ) ,
                      ...
                      column( 
                        ...
                        actionButton("sc1a3tog2", "Customize Fig"), 
                        conditionalPanel( 
                          condition = "input.sc1a3tog2 % 2 == 1", 
                          radioButtons("sc1a3col2", "Colour (Continuous data):", 
                                       choices = c("White-Red", "Blue-Yellow-Red", 
                                                   "Yellow-Green-Purple"), 
                                       selected = "Blue-Yellow-Red"), 
                          radioButtons("sc1a3ord2", "Plot order:", 
                                       choices = c("Max-1st", "Min-1st", "Original", "Random"), 
                                       selected = "Original", inline = TRUE), 
                          checkboxInput("sc1a3lab2", "Show cell info labels", value = TRUE) 
                        ),
      ...
      tabPanel( 
        ...
        sidebarLayout( 
          sidebarPanel(width=2,
                                ...
                                helper(type = "inline", size = "m", fade = TRUE, 
                                       ...
                                       content = c("Select gene to colour cells by gene expression", 
                                                   paste0("- Gene expression are coloured in a ", 
                                                          ...
                                                          "changed in the plot controls")))),
                       actionButton("sc1b2togL", "Subset cells"), 
                       conditionalPanel( 
                       ...
                       column(12, p(), style = "background-color: transparent;"),
                       actionButton("sc1b2tog0", "Graphics controls"), 
                       conditionalPanel( 
          ...
          mainPanel(
            column(6,
                   ...
                   actionButton("sc1b2tog1", "Customize Fig"), 
                   conditionalPanel( 
      ...
      tabPanel( 
        ...
        sidebarLayout(
          sidebarPanel(width=2,
                       ...
                       actionButton("sc1c1togL", "Subset cells"), 
                       conditionalPanel( 
                       ...
                       column(12, p(), style = "background-color: transparent;"),
                       actionButton("sc1c1tog", "Graphics controls"), 
                       conditionalPanel( 
          ...
          mainPanel(width=6, uiOutput("sc1c1oup.ui"),  
      ...
      tabPanel( 
        ...
        sidebarLayout(
          sidebarPanel(width=2,
                       ...
                       actionButton("sc1c2togL", "Subset cells"), 
                       conditionalPanel( 
                       ...
                       column(12, p(), style = "background-color: transparent;"),
                       br(),
                       actionButton("sc1c2tog", "Graphics controls"), 
                       conditionalPanel( 
      ...
      tabPanel( 
        ...
        sidebarLayout( 
          sidebarPanel(width=2,
                       ...
                       actionButton("sc1d1togL", "Subset cells"), 
                       conditionalPanel( 
                       ...
                       column(12, p(), style = "background-color: transparent;"),
                       actionButton("sc1d1tog", "Graphics controls"), 
                       conditionalPanel( 
          ...
          mainPanel(width=6, h4(htmlOutput("sc1d1oupTxt")), 
      ...
      navbarMenu("Dataset Links",
                 tabPanel(
                   tags$a(href = "https://read.shinyapps.io/bt109/", target = "_blank",style = "font-weight: bold; font-size: 14px","BT109 Engrafted Tumor cells (DMG)")
                 ),
                 tabPanel(
                   tags$a(href = "https://read.shinyapps.io/bt85/", target = "_blank",style = "font-weight: bold; font-size: 14px", "BT85 Engrafted Tumor cells (pGBM)")
                 ),
                 tabPanel(
                   tags$a(href = "https://read.shinyapps.io/gbmnsp/", target = "_blank",style = "font-weight: bold; font-size: 14px", "GBM Neurosphere cell lines (4GBMs)")
                 ))
    ),      # End of tab (2 space)     
    br(),
    br(),
    br(),
    p(em("Created on May-16-2024")), 
    br(),br(),br(),br(),br() 
  )
)

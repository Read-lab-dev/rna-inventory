...
shinyServer(function(input, output, session) { 
 ...
 optCrt="{ option_create: function(data,escape) {return('<div class=\"create\"><strong>' + '</strong></div>');} }" 
  ...
  output$sc1a1oup1.ui <- renderUI({ 
    plotOutput("sc1a1oup1", width = "75%",height = pList[input$sc1a1psz]) 
  }) 
  ...
  output$sc1a1oup2.ui <- renderUI({ 
    plotOutput("sc1a1oup2", width = "75%",height = pList[input$sc1a1psz]) 
  }) 
  ...
  output$sc1a2oup1.ui <- renderUI({ 
    plotOutput("sc1a2oup1",  width = "75%",height = pList[input$sc1a2psz]) 
  }) 
  ...
  output$sc1a2oup2.ui <- renderUI({ 
    plotOutput("sc1a2oup2",  width = "75%",height = pList[input$sc1a2psz]) 
  }) 
  ...
  output$sc1a3oup1.ui <- renderUI({ 
    plotOutput("sc1a3oup1",  width = "75%",height = pList[input$sc1a3psz]) 
  }) 
  ...
  output$sc1a3oup2.ui <- renderUI({ 
    plotOutput("sc1a3oup2",  width = "75%",height = pList[input$sc1a3psz]) 
  }) 
